...
CosteCiudad costeMedioMinEj13(matriz<double> costes, vector<Ciudad> ciudadCostera)
{
...
vector<PuenteEj13> puentesHuries(GrafoP<double> G1, GrafoP<double> G2, GrafoP<double> G3,
                           ...
                           vector<Ciudad> costa3)
{
    ...
    if (ciudadMin1.coste < ciudadMin2.coste && ciudadMin1.coste < ciudadMin3.coste)
